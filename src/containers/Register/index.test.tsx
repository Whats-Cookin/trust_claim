...
describe("Register component", () => {
  ...
  it("should render Register component", async () => {
    const { getByLabelText } = render(<MemoryRouter><Register toggleSnackbar={undefined} setSnackbarMessage={undefined} setLoading={undefined} /></MemoryRouter>);
  ...
  it("should display an error message if registration fails", async () => {
    ...
    const { getByLabelText, queryByText } = render(<MemoryRouter><Register toggleSnackbar={undefined} setSnackbarMessage={undefined} setLoading={undefined} /></MemoryRouter>);
...
// 
  ...
  test("should navigate to login page on successful registration", async () => {
    ...
    render(<MemoryRouter><Register toggleSnackbar={undefined} setSnackbarMessage={undefined} setLoading={undefined} /></MemoryRouter>);
    const emailInput = getByLabelText("Email") as HTMLInputElement;
    const passwordInput = getByLabelText("Password") as HTMLInputElement;
    ...
    await waitFor(() =>
    expect(screen.queryByText('Redirecting to login page...')).not.toBeInTheDocument()
  );
  });
  });
