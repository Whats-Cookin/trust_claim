      ...
      <ContentWrapper>
              ...
              {subjectNode || claim.subjectNode ? (
                ...
                >
                  {subjectNode?.image || claim.subjectNode?.image ? (
                    ...
                    >
                      <BusinessIcon sx={{ fontSize: { xs: 30, md: 40 } }} />
                    </Avatar>
                  )}
                  <Box flex={1} sx={{ textAlign: { xs: 'center', md: 'left' }, width: '100%' }}>
                ...
                <Box sx={{ textAlign: 'center' }}>
                  ...
                  <Typography variant={isMobile ? 'h5' : 'h4'} sx={{ fontWeight: 700, mb: 2 }}>
        ...
        <ClaimCard elevation={0}>
          <CardContent sx={{ p: { xs: 3, md: 4 } }}>
            <Stack spacing={3}>
              <Box>
                <Typography variant={isMobile ? 'h6' : 'h5'} sx={{ fontWeight: 600, mb: 2, textTransform: 'capitalize' }}>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Grid container spacing={3}>
              {relatedClaims.map((relatedClaim, index) => (
                <Grid item xs={12} sm={6} lg={4} key={relatedClaim.id || `related-${index}`}>
